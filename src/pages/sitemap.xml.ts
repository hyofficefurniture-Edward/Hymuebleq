...
const staticPaths = [
  ...
  "/recursos/mesas-sala-juntas-guia/",
  "/recursos/sofa-espacios-pequenos/",
  "/recursos/camas-tapizadas-guia/",
  "/recursos/mobiliario-clinica-equipamiento/",
  "/recursos/mobiliario-hotelero-guia-compra/",
  "/recursos/mobiliario-oficina-ergonomico/",
  "/recursos/mobiliario-escolar-escritorios-regulables/",
  "/recursos/mobiliario-medico-sala-espera/",
  "/recursos/encimeras-piedra-sinterizada-ventajas/",
  "/recursos/como-elegir-sofa-salon/",
  "/recursos/vestidor-medida-planificacion/",
  "/recursos/presupuesto-ffe-hotel-tipo-habitacion/",
  "/recursos/pip-hotel-reemplazo-ffe/",
  "/recursos/escritorios-elevables-especificaciones-compra/",
  "/recursos/sala-espera-hospitalaria-control-infecciones/",
  "/recursos/mobiliario-aula-estandares-altura-asiento/",
  "/recursos/mesa-comedor-medida-villa/",
  "/recursos/encimera-cocina-piedra-sinterizada/",
  "/recursos/ffande-sourcing-china-verificar-fabricante/",
  "/recursos/casegoods-muebles-sueltos-hotel/",
  "/recursos/sillas-oficina-capacidad-peso-bifma/",
  "/recursos/muebles-antiligadura-salud-mental/",
  "/recursos/mobiliario-laboratorio-stem/",
  "/recursos/vestidor-villas-medidas-luz/",
  "/recursos/pared-ducha-piedra-sinterizada/",
  "/recursos/lista-aprobacion-muestras-preproduccion/",
  "/recursos/garantia-muebles-clausulas-riesgo/",
  "/recursos/bs-5852-tapiceria-seguridad-incendio-reino-unido/",
  "/recursos/iso-9001-vs-iso-14001-fabricacion-muebles/",
  "/recursos/logica-pedido-minimo-moq-muebles/",
  "/recursos/mobiliario-preescolar-kindergarten-medidas/",
  "/recursos/mobiliario-sala-conferencias-medidas-av/",
  "/recursos/mobiliario-consultorio-examen-medico/",
  "/recursos/muebles-sala-cine-casa/",
  "/recursos/revestimiento-pared-piedra-sinterizada/",
  "/recursos/acabado-a-mano-que-significa-muebles/",
  "/recursos/suspension-asiento-webbing-resortes-drop-in/",
  "/recursos/melamina-vs-hpl-vs-laminado-compacto-mesas/",
  "/recursos/cotizar-casegoods-hotel-200-habitaciones/",
  "/recursos/banderas-rojas-presupuesto-muebles-cotizacion/",
  "/recursos/herrajes-laton-acero-inoxidable-bronce/",
  "/recursos/certificacion-fsc-muebles-verificacion/",
  "/recursos/recubrimiento-polvo-vs-pintura-anodizado/",
  "/recursos/mobiliario-restaurante-hotel-fb-2026/",
  "/recursos/mantenimiento-muebles-hotel-calendario-2026/",
  "/recursos/mobiliario-dormitorios-universitarios-2026/",
  "/recursos/almacenamiento-aula-escolar-casilleros-2026/",
  ...
  "/recursos/precio-sofa-medida-decodificado-2026/",
  "/recursos/espuma-envuelta-plumon-cojines-lujo/",
  "/recursos/proceso-compras-ffe-hoteles-7-etapas/",
  "/recursos/por-que-crujen-sillas-hotel-bastidor/",
  "/recursos/videos/",
  "/productos/",
  "/productos/pagina-2/",
