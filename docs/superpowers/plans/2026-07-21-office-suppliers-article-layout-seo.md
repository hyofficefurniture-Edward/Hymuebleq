...
<style>
  ...
  @media (max-width: 620px) {
    ...
    .office-guide .capability-table th,
    .office-guide .capability-table td {
      overflow-wrap: anywhere;
    }

    .office-guide .capability-table th:nth-child(1),
    .office-guide .capability-table td:nth-child(1) {
      width: 25%;
    }

    .office-guide .capability-table th:nth-child(2),
    .office-guide .capability-table td:nth-child(2) {
      width: 55%;
    }

    .office-guide .capability-table th:nth-child(3),
    .office-guide .capability-table td:nth-child(3) {
      width: 20%;
    }
