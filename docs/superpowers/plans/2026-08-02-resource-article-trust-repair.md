...
- [x] Preserve the original author's visible sequence: China-sourcing rationale, screening method, descriptive supplier headings, and supplier-by-supplier comparison table.
